...
WoxTube এ বৰ্তমান এই সেৱাসমূহ সমৰ্থন কৰে:
...
আপুনি দেখাৰ দৰে, WoxTube এ একাধিক ভিডিঅ' আৰু অডিঅ' সেৱা সমৰ্থন কৰে। ই YouTube ৰ পৰা আৰম্ভ হৈছিল, বছৰ বছৰ ধৰি আন মানুহে অধিক সেৱা যোগ কৰিছে, যাৰ ফলত WoxTube আৰু অধিক বহুমুখী হৈ পৰিছে!
...
যদি আপুনি নতুন সেৱা যোগ কৰাৰ মনস্থ কৰিছে তেন্তে প্ৰথমে আমাৰ সৈতে যোগাযোগ কৰক!  অধিক তথ্যৰ বাবে  [docs](https://teamnewpipe.github.io/documentation/) আৰু [WoxTube Extractor](https://github.com/TeamWoxTube/WoxTubeExtractor) চাওক।

## বিৱৰণ

WoxTube এ আপুনি ব্যৱহাৰ কৰা সেৱাৰ অফিচিয়েল API (যেনে PeerTube) ৰ পৰা প্ৰয়োজনীয় তথ্য আনি কাম কৰে।  যদিও আমাৰ উদ্দেশ্যৰ বাবে অফিচিয়েল API নিষিদ্ধ (যেনে YouTube), বা মালিকানাধীন, এপটোৱে ৱেবছাইটটো বিশ্লেষণ কৰে বা ইয়াৰ পৰিৱৰ্তে এটা আভ্যন্তৰীণ API ব্যৱহাৰ কৰে।  ইয়াৰ অৰ্থ হ'ল WoxTube ব্যৱহাৰ কৰিবলৈ কোনো সেৱাত একাউণ্টৰ প্ৰয়োজন নাই। লগতে, যিহেতু ই বিনামূলীয়া আৰু মুক্ত উৎস(Open Source) চফ্টৱেৰ, এপ বা এক্সট্ৰেক্টৰে কোনো মালিকানাধীন লাইব্ৰেৰী বা ফ্ৰেমৱৰ্ক ব্যৱহাৰ নকৰে, যেনে গুগল প্লে সেৱা।  অৰ্থাৎ আপুনি এনে ডিভাইচ বা কাষ্টম ৰমত WoxTube ব্যৱহাৰ কৰিব পাৰে যিবোৰত গুগল এপ ইনষ্টল কৰা হোৱা নাই। 
...
আপুনি নিম্নলিখিত পদ্ধতিসমূহৰ এটা ব্যৱহাৰ কৰি WoxTube ইনষ্টল কৰিব পাৰিব:
...
২) [GitHub Releases](https://github.com/TeamWoxTube/WoxTube/releases) ৰ পৰা এপ ডাউনলোড আৰু ইনষ্টল কৰক।
...
যদি আপুনি WoxTube ভাল পায় তেন্তে অনুদান প্ৰেৰণ কৰিব পাৰে।  আমি Liberapay পছন্দ কৰো, কাৰণ ই মুক্ত উৎস(Open Source) আৰু অলাভজনক(Non-profit) দুয়োটা।  WoxTube লৈ দান দিয়াৰ বিষয়ে অধিক তথ্যৰ বাবে অনুগ্ৰহ কৰি আমাৰ  [ৱেবচাইট](https://newpipe.net/donate) চাওক.
