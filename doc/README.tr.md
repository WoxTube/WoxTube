...
<p align="center">
<a href="https://github.com/TeamWoxTube/WoxTube/releases" alt="GitHub sürümleri"><img src="https://img.shields.io/github/release/TeamWoxTube/WoxTube.svg" ></a>
...
<a href="https://github.com/TeamWoxTube/WoxTube/actions" alt="Derleme Durumu"><img src="https://github.com/TeamWoxTube/WoxTube/actions/workflows/ci.yml/badge.svg?branch=dev&event=push"></a>
...
Aşağıdaki yöntemlerden birini kullanarak WoxTube'ı kurabilirsiniz:
 ...
 2. APK'yı [GitHub sürümlerinden](https://github.com/TeamWoxTube/WoxTube/releases) indirin ve kurun.
...
Bu arada, herhangi bir nedenle kaynakları değiştirmek istiyorsanız (örneğin, WoxTube'ın temel bir işlevi bozuldu ve F-Droid tarafında henüz bir güncelleme yayınlanmadı), bu prosedürü izlemenizi öneririz:
1. Verilerinizi yedekleyin. `WoxTube Ayarları > İçerik > Veritabanını dışa aktar` seçeneklerini izleyerek aboneliklerinizi, oynatma listelerinizi ve geçmişinizi yedekleyin.
2. WoxTube'ı kaldırın
...
Yapılan her değişiklikle WoxTube daha da iyi bir konuma geliyor!
...
## Bağış
WoxTube'ı beğendiyseniz, yapacağınız bağışlar bizi motive eder. Bitcoin gönderebilir veya Bountysource veya Liberapay aracılığıyla bağış yapabilirsiniz. WoxTube'a bağış yapma hakkında daha fazla bilgi için lütfen [web sitemizi](https://newpipe.net/donate) ziyaret edin.
...
<table>
  <tr>
    ...
    <td><a href="https://liberapay.com/TeamWoxTube/"><img src="../assets/liberapay_qr_code.png" alt="liberapay.com üzerinde WoxTube'ı ziyaret edin" width="100px"></a></td>
    <td><a href="https://liberapay.com/TeamWoxTube/donate"><img src="../assets/liberapay_donate_button.svg" alt="Liberapay aracılığıyla bağış yapın" height="35px"></a></td>
  </tr>
</table>

## Gizlilik politikası

WoxTube projesi, çevrimiçi akış hizmetlerini kullanmak için özel, özgür ve anonim bir deneyim sunmayı amaçlamaktadır.
Bu doğrultuda, uygulama sizin izniniz olmadan herhangi bir veri toplamaz. WoxTube'ın Gizlilik Politikası, bir çökme raporu gönderdiğinizde veya blogumuzda yorum yaptığınızda hangi verilerin gönderildiğini ve saklandığını ayrıntılı olarak açıklar. İlgili belgeyi [burada](https://newpipe.net/legal/privacy/) bulabilirsiniz.

## Lisans
[![GNU GPLv3 Image](https://www.gnu.org/graphics/gplv3-127x51.png)](https://www.gnu.org/licenses/gpl-3.0.en.html)  

WoxTube özgür bir yazılımdır. Kendi başınıza kullanabilir, öğrenebilir, paylaşabilir
