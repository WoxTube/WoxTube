...
<p align="center">
<a href="https://github.com/TeamWoxTube/WoxTube/releases" alt="Lanzamientos GitHub"><img src="https://img.shields.io/github/release/TeamWoxTube/WoxTube.svg" ></a>
...
<a href="https://github.com/TeamWoxTube/WoxTube/actions" alt="Estado del Build"><img src="https://github.com/TeamWoxTube/WoxTube/actions/workflows/ci.yml/badge.svg?branch=dev&event=push"></a>
...
WoxTube no usa ninguna librería del framework de Google, ni la API de YouTube. Los sitios web solamente se analizan para extraer la información requerida, por lo que esta app se puede usar sin los servicios de Google instalados. Además, no se necesita una cuenta de YouTube para usar WoxTube, que es un programa libre <i lang="en">copyleft</i>.
...
WoxTube soporta varios servicios. Nuestras [documentaciones](https://teamnewpipe.github.io/documentation/) ofrecen más información sobre cómo se puede agregar un servicio nuevo a la app y al extractor. Por favor ponte en contacto con nosotros si tienes pensado agregar uno nuevo. Actualmente los servicios soportados son:
...
Se puede instalar WoxTube usando uno de los métodos siguientes:
 ...
 2. Descargando el archivo APK de [aquí](https://github.com/TeamWoxTube/WoxTube/releases) y posteriormente instalarlo.
...
Además, si quiere cambiar el método de instalación por alguna razón (por ejemplo: la funcionalidad del núcleo de WoxTube se rompe o F-Droid aún no publica la actualización), recomendamos el siguiente procedimiento:
...
Si tiene ideas, traducciones, cambios de diseño, limpieza de código o cambios grandes de código, su ayuda es siempre bienvenida. ¡Cuanto más hagamos, WoxTube será mucho mejor!
...
## Donar
Si te gusta WoxTube, estaremos felices con una donación. Puede enviar bitcoin o donar a través de Bountysource o Liberapay. Visita nuestro [sitio web](https://newpipe.net/donate) para más información.
...
<table>
  <tr>
    ...
    <td><a href="https://liberapay.com/TeamWoxTube/"><img src="../assets/liberapay_qr_code.png" alt="Visita WoxTube en liberapay.com" width="100px"></a></td>
    <td><a href="https://liberapay.com/TeamWoxTube/donate"><img src="../assets/liberapay_donate_button.svg" alt="Dona vía Liberapay" height="35px"></a></td>
  </tr>
</table>

## Política de Privacidad

El proyecto WoxTube tiene como objetivo ofrecer una experience privada y anónima al usar servicios web multimedia. Por lo tanto, la app no recoleta ningún tipo de información sin su consentimiento. La politica de privacidad de WoxTube explica en detalle qué información es enviada y almacenada cuando envía un informe de error o comenta en [nuestro blog](https://newpipe.net/blog/). Puede encontrar el documento [aquí](https://newpipe.net/legal/privacy/).

## Licencia

[![GNU GPLv3 Image](https://www.gnu.org/graphics/gplv3-127x51.png)](https://www.gnu.org/licenses/gpl-3.0.html)

WoxTube es Software Libre: Puede usarlo, estudiarlo, compartirlo y mejorarlo a su voluntad. Más específicamente, puede redistribuirlo y/o modificarlo bajo los términos de la [GNU General Public License](https://www.gnu.org/licenses/gpl.html) publicada por la Free Software Foundation tanto si usa la versión 3 o posterior de la licencia.
