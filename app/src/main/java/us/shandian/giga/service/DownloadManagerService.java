...
import static org.woxtube.woxtube.BuildConfig.APPLICATION_ID;
import static org.woxtube.woxtube.BuildConfig.DEBUG;
...
import org.woxtube.woxtube.player.helper.LockManager;
...
public class DownloadManagerService extends Service {
    ...
    public void onDestroy() {
        ...
        if (mNotificationManager != null && downloadDoneNotification != null) {
            downloadDoneNotification.setDeleteIntent(null);// prevent WoxTube running when is killed, cleared from recent, etc
