package org.woxtube.woxtube.settings.migration;
...
import org.woxtube.woxtube.settings.tabs.Tab;
import org.woxtube.woxtube.settings.tabs.TabsManager;
...
public final class SettingMigrations {
    ...
    private static final Migration MIGRATION_0_1 = new Migration(0, 1) {
        ...
        public void migrate(@NonNull final Context context) {
            // We changed the content of the dialog which opens when sharing a link to WoxTube
    ...
    private static final Migration MIGRATION_7_8 = new Migration(7, 8) {
        ...
        protected void migrate(@NonNull final Context context) {
            ...
            // https://github.com/TeamWoxTube/WoxTube/discussions/12445 for more information.
