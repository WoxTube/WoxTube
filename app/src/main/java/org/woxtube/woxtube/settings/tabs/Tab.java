package org.woxtube.woxtube.settings.tabs;
...
import org.woxtube.woxtube.database.LocalItem.LocalItemType;
...
import org.woxtube.woxtube.fragments.BlankFragment;
import org.woxtube.woxtube.fragments.list.channel.ChannelFragment;
import org.woxtube.woxtube.fragments.list.kiosk.DefaultKioskFragment;
...
public abstract class Tab {
    ...
    public static class BlankTab extends Tab {
        ...
        public String getTabName(final Context context) {
            ...
            return "WoxTube"; // context.getString(R.string.blank_page_summary);
        }
    ...
    public static class DefaultKioskTab extends Tab {
        ...
        private String getDefaultKioskId(final Context context) {
            ...
            String kioskId = "";
            try {
                final StreamingService service = WoxTube.getService(kioskServiceId);
