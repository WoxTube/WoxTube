...
import org.woxtube.woxtube.settings.export.BackupFileLocator;
import org.woxtube.woxtube.settings.export.ImportExportManager;
...
import org.woxtube.woxtube.util.ZipHelper;
        ...
        exportDataPreference.setOnPreferenceClickListener((final Preference p) -> {
            NoFileManagerSafeGuard.launchSafe(
                    ...
                    StoredFileHelper.getNewPicker(requireContext(),
                            "WoxTubeData-" + exportDateFormat.format(new Date()) + ".zip",
                            ZIP_MIME_TYPE, getImportExportDataUri()),
                    TAG,
                    getContext()
            );
    ...
    private void cleanImport(@NonNull final Context context,
        ...
        if (wasMediaTunnelingDisabledAutomatically) {
            prefs.edit()
                    ...
                    .apply();
            WoxTubeSettings.setMediaTunneling(context);
        }
    }
