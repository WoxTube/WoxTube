...
public class DownloadSettingsFragment extends BasePreferenceFragment {
    ...
    public void onCreatePreferences(final Bundle savedInstanceState, final String rootKey) {
        ...
        prefUseSaf.setChecked(WoxTubeSettings.useStorageAccessFramework(ctx));
    ...
    public boolean onPreferenceTreeClick(@NonNull final Preference preference) {
        ...
        if (key.equals(storageUseSafPreference)) {
            if (!WoxTubeSettings.useStorageAccessFramework(ctx)) {
                WoxTubeSettings.saveDefaultVideoDownloadDirectory(ctx);
                WoxTubeSettings.saveDefaultAudioDownloadDirectory(ctx);
            } else {
