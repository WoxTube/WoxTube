...
import org.woxtube.woxtube.extractor.feed.FeedInfo
import org.woxtube.woxtube.extractor.stream.StreamInfoItem
import org.woxtube.woxtube.ktx.getStringSafe
import org.woxtube.woxtube.local.feed.FeedDatabaseManager
import org.woxtube.woxtube.local.subscription.SubscriptionManager
import org.woxtube.woxtube.util.ChannelTabHelper
import org.woxtube.woxtube.util.ExtractorHelper.getChannelInfo
import org.woxtube.woxtube.util.ExtractorHelper.getChannelTab
import org.woxtube.woxtube.util.ExtractorHelper.getMoreChannelTabItems
...
class FeedLoadManager(private val context: Context) {
    ...
    private fun loadStreams(
        ...
        try {
            ...
            if (useFeedExtractor) {
                WoxTube.getService(subscriptionEntity.serviceId)
