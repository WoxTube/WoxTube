...
import static org.woxtube.woxtube.extractor.subscription.SubscriptionExtractor.ContentSource.CHANNEL_URL;
import static org.woxtube.woxtube.local.subscription.services.SubscriptionsImportService.CHANNEL_URL_MODE;
import static org.woxtube.woxtube.local.subscription.services.SubscriptionsImportService.INPUT_STREAM_MODE;
import static org.woxtube.woxtube.local.subscription.services.SubscriptionsImportService.KEY_MODE;
import static org.woxtube.woxtube.local.subscription.services.SubscriptionsImportService.KEY_VALUE;
...
import org.woxtube.woxtube.extractor.subscription.SubscriptionExtractor;
...
public class SubscriptionsImportFragment extends BaseFragment {
    ...
    private void setupServiceVariables() {
        if (currentServiceId != Constants.NO_SERVICE_ID) {
            try {
                final SubscriptionExtractor extractor = WoxTube.getService(currentServiceId)
