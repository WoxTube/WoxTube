 ...
 * FeedFragment.kt is part of WoxTube
 *
 * License: GPL-3.0+
...
package org.woxtube.woxtube.local.feed
...
import org.woxtube.woxtube.databinding.FragmentFeedBinding
...
import org.woxtube.woxtube.extractor.exceptions.AccountTerminatedException
...
import org.woxtube.woxtube.extractor.utils.Utils.isNullOrEmpty
import org.woxtube.woxtube.fragments.BaseStateFragment
import org.woxtube.woxtube.info_list.ItemViewMode
import org.woxtube.woxtube.info_list.dialog.InfoItemDialog
import org.woxtube.woxtube.ktx.animate
import org.woxtube.woxtube.ktx.animateHideRecyclerViewAllowingScrolling
import org.woxtube.woxtube.ktx.slideUp
import org.woxtube.woxtube.local.feed.item.StreamItem
import org.woxtube.woxtube.local.feed.service.FeedLoadService
import org.woxtube.woxtube.local.subscription.SubscriptionManager
...
import org.woxtube.woxtube.util.ThemeHelper.getGridSpanCountStreams
import org.woxtube.woxtube.util.ThemeHelper.getItemViewMode
import org.woxtube.woxtube.util.ThemeHelper.resolveDrawable
import org.woxtube.woxtube.util.ThemeHelper.shouldUseGridLayout
    ...
    private fun handleItemsErrors(errors: List<Throwable>) {
        errors.forEachIndexed { i, t ->
            if (t is FeedLoadService.RequestException &&
                ...
                disposables.add(
                    Single.fromCallable {
                        WoxTubeDatabase.getInstance(requireContext()).subscriptionDAO()
