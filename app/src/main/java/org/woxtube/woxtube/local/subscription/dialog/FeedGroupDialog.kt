package org.woxtube.woxtube.local.subscription.dialog
...
import org.woxtube.woxtube.databinding.DialogFeedGroupCreateBinding
import org.woxtube.woxtube.databinding.ToolbarSearchLayoutBinding
import org.woxtube.woxtube.fragments.BackPressable
import org.woxtube.woxtube.local.subscription.FeedGroupIcon
import org.woxtube.woxtube.local.subscription.dialog.FeedGroupDialog.ScreenState.DeleteScreen
import org.woxtube.woxtube.local.subscription.dialog.FeedGroupDialog.ScreenState.IconPickerScreen
import org.woxtube.woxtube.local.subscription.dialog.FeedGroupDialog.ScreenState.InitialScreen
import org.woxtube.woxtube.local.subscription.dialog.FeedGroupDialog.ScreenState.SubscriptionsPickerScreen
import org.woxtube.woxtube.local.subscription.dialog.FeedGroupDialogViewModel.DialogEvent.ProcessingEvent
import org.woxtube.woxtube.local.subscription.dialog.FeedGroupDialogViewModel.DialogEvent.SuccessEvent
import org.woxtube.woxtube.local.subscription.item.ImportSubscriptionsHintPlaceholderItem
import org.woxtube.woxtube.local.subscription.item.PickerIconItem
import org.woxtube.woxtube.local.subscription.item.PickerSubscriptionItem
