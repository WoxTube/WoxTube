 ...
 * SubscriptionsImportService.java is part of WoxTube
 *
 * License: GPL-3.0+
...
package org.woxtube.woxtube.local.subscription.services;

import static org.woxtube.woxtube.MainActivity.DEBUG;
import static org.woxtube.woxtube.streams.io.StoredFileHelper.DEFAULT_MIME;
...
import org.woxtube.woxtube.extractor.subscription.SubscriptionItem;
import org.woxtube.woxtube.ktx.ExceptionUtils;
import org.woxtube.woxtube.streams.io.SharpInputStream;
...
public class SubscriptionsImportService extends BaseImportExportService {
    ...
    private Flowable<List<SubscriptionItem>> importFromChannelUrl() {
        return Flowable.fromCallable(() -> WoxTube.getService(currentServiceId)
