package org.woxtube.woxtube.local.dialog;
...
public abstract class PlaylistDialog extends DialogFragment implements StateSaver.WriteRead {
    ...
    private org.woxtube.woxtube.util.SavedState savedState;
    ...
    public static Disposable createCorrespondingDialog(
        ...
        return new LocalPlaylistManager(WoxTubeDatabase.getInstance(context))
                .hasPlaylists()
