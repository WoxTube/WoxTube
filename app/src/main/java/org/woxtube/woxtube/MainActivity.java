 ...
 * DownloadActivity.java is part of WoxTube.
 * <p>
...
import org.woxtube.woxtube.databinding.ActivityMainBinding;
import org.woxtube.woxtube.databinding.DrawerHeaderBinding;
import org.woxtube.woxtube.databinding.DrawerLayoutBinding;
import org.woxtube.woxtube.databinding.InstanceSpinnerLayoutBinding;
import org.woxtube.woxtube.databinding.ToolbarLayoutBinding;
...
import org.woxtube.woxtube.extractor.services.peertube.PeertubeInstance;
...
import org.woxtube.woxtube.fragments.list.comments.CommentRepliesFragment;
import org.woxtube.woxtube.fragments.list.search.SearchFragment;
import org.woxtube.woxtube.local.feed.notifications.NotificationWorker;
...
import org.woxtube.woxtube.settings.UpdateSettingsFragment;
import org.woxtube.woxtube.settings.migration.MigrationManager;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        // https://github.com/TeamWoxTube/WoxTube/issues/12016
    ...
    private void addDrawerMenuForCurrentService() throws ExtractionException {
        ...
        final StreamingService service = WoxTube.getService(currentServiceId);
    ...
    private void setupDrawerHeader() {
        ...
        // If the current app name is bigger than the default "WoxTube" (7 chars),
        // let the text view grow a little more as well.
        if (getString(R.string.app_name).length() > "WoxTube".length()) {
    ...
    private void showServices() {
        for (final StreamingService s : WoxTube.getServices()) {
    ...
    protected void onResume() {
        ...
        try {
            ...
            final String selectedServiceName = WoxTube.getService(selectedServiceId)
