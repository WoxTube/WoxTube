 ...
 * ThemeHelper.java is part of WoxTube
 *
 * License: GPL-3.0+
...
public final class ThemeHelper {
    ...
    /**
     * Apply the selected theme (on WoxTube settings) in the context
    ...
    /**
     * Return true if the selected theme (on WoxTube settings) is the Light theme.
     *
