...
import org.woxtube.woxtube.extractor.linkhandler.LinkHandlerFactory;
...
public final class InternalUrlsHandler {
    ...
    /**
     * Handle a YouTube timestamp comment URL in WoxTube.
     * <p>
     ...
     * @return true if the URL can be handled by WoxTube, false if it cannot
     */
    ...
    /**
     * Handle a YouTube timestamp description URL in WoxTube.
     * <p>
    ...
    /**
     * Handle an URL in WoxTube.
     * <p>
     * This method will check if the provided url can be handled in WoxTube or not. If this is a
    ...
    private static boolean handleUrl(final Context context,
        ...
        try {
            service = WoxTube.getServiceByUrl(matchedUrl);
