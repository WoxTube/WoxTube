package org.woxtube.woxtube.util.potoken

import android.os.Handler
import android.os.Looper
import android.util.Log
import org.woxtube.woxtube.App
import org.woxtube.woxtube.BuildConfig
import org.woxtube.woxtube.extractor.WoxTube
import org.woxtube.woxtube.extractor.services.youtube.InnertubeClientRequestInfo
import org.woxtube.woxtube.extractor.services.youtube.PoTokenProvider
import org.woxtube.woxtube.extractor.services.youtube.PoTokenResult
    ...
    private fun getWebClientPoToken(videoId: String, forceRecreate: Boolean): PoTokenResult {
            ...
            synchronized(WebPoTokenGenLock) {
                ...
                if (shouldRecreate) {
                    ...
                    webPoTokenVisitorData = YoutubeParsingHelper.getVisitorDataFromInnertube(
                        ...
                        WoxTube.getPreferredLocalization(),
                        WoxTube.getPreferredContentCountry(),
        ...
        val playerPot = try {
            ...
            if (hasBeenRecreated) {
                ...
                // this might happen for example if WoxTube goes in the background and the WebView
                // content is lost
