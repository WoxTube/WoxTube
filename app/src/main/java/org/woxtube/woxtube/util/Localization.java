...
import org.woxtube.woxtube.extractor.localization.DateWrapper;
import org.woxtube.woxtube.extractor.stream.AudioStream;
import org.woxtube.woxtube.extractor.stream.AudioTrackType;
 ...
 * Localization.java is part of WoxTube.
 *
...
public final class Localization {
    ...
    public static org.woxtube.woxtube.extractor.localization.Localization getPreferredLocalization(
            final Context context) {
        return org.woxtube.woxtube.extractor.localization.Localization
     ...
     * @param parsed  the textual date or time ago parsed by WoxTubeExtractor, or {@code null} if
    ...
    // Starting with pull request #12093, WoxTube exclusively uses Android's
    // public per-app language APIs to read and set the UI language for WoxTube.
