 ...
 * ExtractorHelper.java is part of WoxTube
 *
 * License: GPL-3.0+
...
import static org.woxtube.woxtube.util.text.TextLinkifier.SET_LINK_MOVEMENT_METHOD;
...
import org.woxtube.woxtube.extractor.ListExtractor.InfoItemsPage;
import org.woxtube.woxtube.extractor.MetaInfo;
import org.woxtube.woxtube.extractor.WoxTube;
import org.woxtube.woxtube.extractor.Page;
import org.woxtube.woxtube.extractor.channel.ChannelInfo;
import org.woxtube.woxtube.extractor.channel.tabs.ChannelTabInfo;
import org.woxtube.woxtube.extractor.comments.CommentsInfo;
...
import org.woxtube.woxtube.extractor.search.SearchInfo;
import org.woxtube.woxtube.extractor.stream.StreamInfo;
import org.woxtube.woxtube.extractor.stream.StreamInfoItem;
import org.woxtube.woxtube.extractor.suggestion.SuggestionExtractor;
import org.woxtube.woxtube.util.text.TextLinkifier;
...
public final class ExtractorHelper {
    ...
    public static Single<SearchInfo> searchFor(final int serviceId, final String searchString,
        ...
        return Single.fromCallable(() ->
                SearchInfo.getInfo(WoxTube.getService(serviceId),
                        WoxTube.getService(serviceId)
                                .getSearchQHFactory()
    ...
    public static Single<InfoItemsPage<InfoItem>> getMoreSearchItems(
        ...
        checkServiceId(serviceId);
        return Single.fromCallable(() ->
                SearchInfo.getMoreItems(WoxTube.getService(serviceId),
                        WoxTube.getService(serviceId)
                                .getSearchQHFactory()
    ...
    public static Single<List<String>> suggestionsFor(final int serviceId, final String query) {
        checkServiceId(serviceId);
        return Single.fromCallable(() -> {
            final SuggestionExtractor extractor = WoxTube.getService(serviceId)
    ...
    public static Single<StreamInfo> getStreamInfo(final int serviceId, final String url,
        ...
        return checkCache(forceLoad, serviceId, url, InfoCache.Type.STREAM,
                Single.fromCallable(() -> StreamInfo.getInfo(WoxTube.getService(serviceId), url)));
    }
    ...
    public static Single<ChannelInfo> getChannelInfo(final int serviceId, final String url,
        ...
        return checkCache(forceLoad, serviceId, url, InfoCache.Type.CHANNEL,
                Single.fromCallable(() ->
                        ChannelInfo.getInfo(WoxTube.getService(serviceId), url)));
    }
    ...
    public static Single<ChannelTabInfo> getChannelTab(final int serviceId,
        ...
        return checkCache(forceLoad, serviceId,
                ...
                Single.fromCallable(() ->
                        ChannelTabInfo.getInfo(WoxTube.getService(serviceId), listLinkHandler)));
    }
    ...
    public static Single<InfoItemsPage<InfoItem>> getMoreChannelTabItems(
        ...
        checkServiceId(serviceId);
        return Single.fromCallable(() ->
                ChannelTabInfo.getMoreItems(WoxTube.getService(serviceId),
    ...
    public static Single<CommentsInfo> getCommentsInfo(final int serviceId,
        ...
        return checkCache(forceLoad, serviceId, url, InfoCache.Type.COMMENTS,
                Single.fromCallable(() ->
                        CommentsInfo.getInfo(WoxTube.getService(serviceId), url)));
    }
    ...
    public static Single<InfoItemsPage<CommentsInfoItem>> getMoreCommentItems(
        ...
        checkServiceId(serviceId);
        return Single.fromCallable(() ->
                CommentsInfo.getMoreItems(WoxTube.getService(serviceId), info, nextPage));
    }
    ...
    public static Single<InfoItemsPage<CommentsInfoItem>> getMoreCommentItems(
        ...
        checkServiceId(serviceId);
        return Single.fromCallable(() ->
                CommentsInfo.getMoreItems(WoxTube.getService(serviceId), url, nextPage));
    }
    ...
    public static Single<PlaylistInfo> getPlaylistInfo(final int serviceId,
        ...
        return checkCache(forceLoad, serviceId, url, InfoCache.Type.PLAYLIST,
                Single.fromCallable(() ->
                        PlaylistInfo.getInfo(WoxTube.getService(serviceId), url)));
    }
    ...
    public static Single<InfoItemsPage<StreamInfoItem>> getMorePlaylistItems(final int serviceId,
        ...
        checkServiceId(serviceId);
        return Single.fromCallable(() ->
                PlaylistInfo.getMoreItems(WoxTube.getService(serviceId), url, nextPage));
    }
    ...
    public static Single<KioskInfo> getKioskInfo(final int serviceId,
        ...
        return checkCache(forceLoad, serviceId, url, InfoCache.Type.KIOSK,
                Single.fromCallable(() -> KioskInfo.getInfo(WoxTube.getService(serviceId), url)));
    }
    ...
    public static Single<InfoItemsPage<StreamInfoItem>> getMoreKioskItems(final int serviceId,
                                                                          ...
                                                                          final Page nextPage) {
        return Single.fromCallable(() ->
                KioskInfo.getMoreItems(WoxTube.getService(serviceId), url, nextPage));
    }
