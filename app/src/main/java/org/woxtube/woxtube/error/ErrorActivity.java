...
import org.woxtube.woxtube.databinding.ActivityErrorBinding;
 ...
 * ErrorActivity.java is part of WoxTube.
 *
...
public class ErrorActivity extends AppCompatActivity {
    ...
    public static final String ERROR_GITHUB_ISSUE_URL =
            "https://github.com/TeamWoxTube/WoxTube/issues";
    ...
    private void openPrivacyPolicyDialog(final Context context, final String action) {
        new AlertDialog.Builder(context)
                ...
                .setPositiveButton(R.string.accept, (dialog, which) -> {
                    ...
                    } else if (action.equals("GITHUB")) { // open the WoxTube issue page on GitHub
