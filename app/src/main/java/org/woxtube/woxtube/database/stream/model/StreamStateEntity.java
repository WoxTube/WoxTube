...
import static org.woxtube.woxtube.database.stream.model.StreamStateEntity.JOIN_STREAM_ID;
...
public class StreamStateEntity {
     ...
     * (60000ms = 60s).
     * @see #isFinished(long)
     * @see org.woxtube.woxtube.database.feed.dao.FeedDAO#getLiveOrNotPlayedStreams()
     * @see org.woxtube.woxtube.database.feed.dao.FeedDAO#getLiveOrNotPlayedStreamsForGroup(long)
     */
