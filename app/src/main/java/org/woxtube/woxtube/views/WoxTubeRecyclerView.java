 ...
 * WoxTubeRecyclerView.java is part of WoxTube.
 *
...
public class WoxTubeRecyclerView extends RecyclerView {
    private static final String TAG = "WoxTubeRecyclerView";
    ...
    public WoxTubeRecyclerView(@NonNull final Context context) {
        super(context);
