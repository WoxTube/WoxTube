...
import static org.woxtube.woxtube.player.seekbarpreview.SeekbarPreviewThumbnailHelper.SeekbarPreviewThumbnailType;
import static org.woxtube.woxtube.player.seekbarpreview.SeekbarPreviewThumbnailHelper.getSeekbarPreviewThumbnailType;
...
import org.woxtube.woxtube.extractor.stream.Frameset;
...
public class SeekbarPreviewThumbnailHolder {
    ...
    private Supplier<Bitmap> createBitmapSupplier(final Bitmap srcBitMap,
        ...
        return () -> {
            ...
            // Fixes: https://github.com/TeamWoxTube/WoxTube/issues/11461
