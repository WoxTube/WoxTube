package org.woxtube.woxtube.player;
...
import static org.woxtube.woxtube.extractor.ServiceList.YouTube;
import static org.woxtube.woxtube.extractor.utils.Utils.isNullOrEmpty;
import static org.woxtube.woxtube.player.helper.PlayerHelper.nextRepeatMode;
import static org.woxtube.woxtube.player.helper.PlayerHelper.retrievePlaybackParametersFromPrefs;
import static org.woxtube.woxtube.player.helper.PlayerHelper.retrieveSeekDurationFromPreferences;
import static org.woxtube.woxtube.player.helper.PlayerHelper.savePlaybackParametersToPrefs;
import static org.woxtube.woxtube.player.notification.NotificationConstants.ACTION_CLOSE;
import static org.woxtube.woxtube.player.notification.NotificationConstants.ACTION_FAST_FORWARD;
import static org.woxtube.woxtube.player.notification.NotificationConstants.ACTION_FAST_REWIND;
import static org.woxtube.woxtube.player.notification.NotificationConstants.ACTION_PLAY_NEXT;
import static org.woxtube.woxtube.player.notification.NotificationConstants.ACTION_PLAY_PAUSE;
import static org.woxtube.woxtube.player.notification.NotificationConstants.ACTION_PLAY_PREVIOUS;
import static org.woxtube.woxtube.player.notification.NotificationConstants.ACTION_RECREATE_NOTIFICATION;
import static org.woxtube.woxtube.player.notification.NotificationConstants.ACTION_REPEAT;
import static org.woxtube.woxtube.player.notification.NotificationConstants.ACTION_SHUFFLE;
import static org.woxtube.woxtube.util.ListHelper.getPopupResolutionIndex;
import static org.woxtube.woxtube.util.ListHelper.getResolutionIndex;
...
import org.woxtube.woxtube.MainActivity;
import org.woxtube.woxtube.R;
import org.woxtube.woxtube.databinding.PlayerBinding;
...
import org.woxtube.woxtube.extractor.Image;
import org.woxtube.woxtube.extractor.stream.AudioStream;
import org.woxtube.woxtube.extractor.stream.StreamInfo;
import org.woxtube.woxtube.extractor.stream.StreamType;
import org.woxtube.woxtube.extractor.stream.VideoStream;
import org.woxtube.woxtube.fragments.detail.VideoDetailFragment;
import org.woxtube.woxtube.local.history.HistoryRecordManager;
import org.woxtube.woxtube.player.event.PlayerEventListener;
import org.woxtube.woxtube.player.event.PlayerServiceEventListener;
import org.woxtube.woxtube.player.helper.AudioReactor;
import org.woxtube.woxtube.player.helper.CustomRenderersFactory;
import org.woxtube.woxtube.player.helper.LoadController;
import org.woxtube.woxtube.player.helper.PlayerDataSource;
import org.woxtube.woxtube.player.helper.PlayerHelper;
import org.woxtube.woxtube.player.mediaitem.MediaItemTag;
import org.woxtube.woxtube.player.mediasession.MediaSessionPlayerUi;
import org.woxtube.woxtube.player.notification.NotificationPlayerUi;
import org.woxtube.woxtube.player.playback.MediaSourceManager;
import org.woxtube.woxtube.player.playback.PlaybackListener;
import org.woxtube.woxtube.player.playqueue.PlayQueue;
import org.woxtube.woxtube.player.playqueue.PlayQueueItem;
import org.woxtube.woxtube.player.resolver.AudioPlaybackResolver;
import org.woxtube.woxtube.player.resolver.VideoPlaybackResolver;
import org.woxtube.woxtube.player.resolver.VideoPlaybackResolver.SourceType;
import org.woxtube.woxtube.player.ui.MainPlayerUi;
import org.woxtube.woxtube.player.ui.PlayerUi;
import org.woxtube.woxtube.player.ui.PlayerUiList;
import org.woxtube.woxtube.player.ui.PopupPlayerUi;
import org.woxtube.woxtube.player.ui.VideoPlayerUi;
import org.woxtube.woxtube.util.DependentPreferenceHelper;
import org.woxtube.woxtube.util.ListHelper;
import org.woxtube.woxtube.util.NavigationHelper;
import org.woxtube.woxtube.util.SerializedCache;
import org.woxtube.woxtube.util.StreamTypeUtil;
...
public final class Player implements PlaybackListener, Listener {
    ...
    public void setRecovery() {
        ...
        // No checks due to https://github.com/TeamWoxTube/WoxTube/pull/7195#issuecomment-962624380
     ...
     */
    // Any error code not explicitly covered here are either unrelated to WoxTube use case
