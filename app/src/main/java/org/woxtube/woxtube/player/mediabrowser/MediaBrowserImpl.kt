package org.woxtube.woxtube.player.mediabrowser
...
import org.woxtube.woxtube.MainActivity.DEBUG
...
import org.woxtube.woxtube.extractor.InfoItem.InfoType
...
import org.woxtube.woxtube.local.bookmark.MergedPlaylistManager
 ...
 * [org.woxtube.woxtube.player.PlayerService]) and the media browser implementation (in this file).
 *
...
class MediaBrowserImpl(
    ...
    private val database = WoxTubeDatabase.getInstance(context)
