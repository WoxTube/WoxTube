...
import org.woxtube.woxtube.ktx.BundleKt;
import org.woxtube.woxtube.player.mediabrowser.MediaBrowserImpl;
import org.woxtube.woxtube.player.mediabrowser.MediaBrowserPlaybackPreparer;
...
public final class PlayerService extends MediaBrowserServiceCompat {
    ...
    public int onStartCommand(final Intent intent, final int flags, final int startId) {
        ...
        // All internal WoxTube intents used to interact with the player, that are sent to the
