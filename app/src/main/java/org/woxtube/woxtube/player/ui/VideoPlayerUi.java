...
import static org.woxtube.woxtube.player.Player.RENDERER_UNAVAILABLE;
import static org.woxtube.woxtube.player.Player.STATE_BUFFERING;
...
import static org.woxtube.woxtube.player.Player.STATE_PAUSED_SEEK;
import static org.woxtube.woxtube.player.Player.STATE_PLAYING;
import static org.woxtube.woxtube.player.helper.PlayerHelper.formatSpeed;
import static org.woxtube.woxtube.player.helper.PlayerHelper.getTimeString;
import static org.woxtube.woxtube.player.helper.PlayerHelper.nextResizeModeAndSaveToPrefs;
...
import org.woxtube.woxtube.extractor.MediaFormat;
...
import org.woxtube.woxtube.player.gesture.DisplayPortion;
import org.woxtube.woxtube.player.helper.PlayerHelper;
import org.woxtube.woxtube.player.mediaitem.MediaItemTag;
import org.woxtube.woxtube.player.playback.SurfaceHolderCallback;
import org.woxtube.woxtube.player.playqueue.PlayQueue;
import org.woxtube.woxtube.player.playqueue.PlayQueueItem;
import org.woxtube.woxtube.player.seekbarpreview.SeekbarPreviewThumbnailHelper;
import org.woxtube.woxtube.player.seekbarpreview.SeekbarPreviewThumbnailHolder;
...
import org.woxtube.woxtube.views.player.PlayerFastSeekOverlay;
    ...
    public boolean onKeyDown(final int keyCode) {
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_DPAD_CENTER:
                ...
                if (player.getCurrentState() == org.woxtube.woxtube.player.Player.STATE_BLOCKED) {
                    return true;
                }
