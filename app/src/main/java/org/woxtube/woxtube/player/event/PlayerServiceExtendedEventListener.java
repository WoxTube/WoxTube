 ...
 * player) is running and is bound to {@link org.woxtube.woxtube.player.helper.PlayerHolder}.
 * "Disconnected" means that either the service (resp. the player) was stopped completely, or that
 * {@link org.woxtube.woxtube.player.helper.PlayerHolder} is not bound.
 */
public interface PlayerServiceExtendedEventListener extends PlayerServiceEventListener {
    /**
     * The player service just connected to {@link org.woxtube.woxtube.player.helper.PlayerHolder},
     ...
     * completely, or {@link org.woxtube.woxtube.player.helper.PlayerHolder} is unbinding.
     */
    void onPlayerDisconnected();

    /**
     * The service got disconnected from {@link org.woxtube.woxtube.player.helper.PlayerHolder},
     * either because {@link org.woxtube.woxtube.player.helper.PlayerHolder} is unbinding or because
