...
import static org.woxtube.woxtube.extractor.ServiceList.SoundCloud;
...
import org.woxtube.woxtube.views.WoxTubeRecyclerView;
...
public abstract class BaseListInfoFragment<I extends InfoItem, L extends ListInfo<I>>
     ...
     * You can use the default implementations from {@link org.woxtube.woxtube.util.ExtractorHelper}.
     *
     ...
     * from {@link org.woxtube.woxtube.util.ExtractorHelper}.</p>
     *
    ...
    private void forbidDownwardFocusScroll() {
        if (itemsList instanceof WoxTubeRecyclerView) {
            ((WoxTubeRecyclerView) itemsList).setFocusScrollAllowed(false);
        }
    }

    private void allowDownwardFocusScroll() {
        if (itemsList instanceof WoxTubeRecyclerView) {
            ((WoxTubeRecyclerView) itemsList).setFocusScrollAllowed(true);
        }
    }
