package org.woxtube.woxtube.fragments.list.search;

import static androidx.recyclerview.widget.ItemTouchHelper.Callback.makeMovementFlags;
import static org.woxtube.woxtube.extractor.utils.Utils.isBlank;
...
import org.woxtube.woxtube.databinding.FragmentSearchBinding;
...
import org.woxtube.woxtube.extractor.search.SearchExtractor;
import org.woxtube.woxtube.extractor.search.SearchInfo;
import org.woxtube.woxtube.extractor.services.peertube.linkHandler.PeertubeSearchQueryHandlerFactory;
import org.woxtube.woxtube.extractor.services.youtube.linkHandler.YoutubeSearchQueryHandlerFactory;
import org.woxtube.woxtube.fragments.BackPressable;
import org.woxtube.woxtube.fragments.list.BaseListFragment;
...
import org.woxtube.woxtube.util.KeyboardUtil;
...
public class SearchFragment extends BaseListFragment<SearchInfo, ListExtractor.InfoItemsPage<?>>
    ...
    public void onAttach(@NonNull final Context context) {
        ...
        showLocalSuggestions = WoxTubeSettings.showLocalSearchSuggestions(activity, prefs);
        showRemoteSuggestions = WoxTubeSettings.showRemoteSearchSuggestions(activity, prefs);
    ...
    private void updateService() {
        try {
            service = WoxTube.getService(serviceId);
    ...
    private void search(@NonNull final String theSearchString,
        ...
        // Check if theSearchString is a URL which can be opened by WoxTube directly
        // and open it if possible.
        try {
            final StreamingService streamingService = WoxTube.getServiceByUrl(theSearchString);
            showLoading();
