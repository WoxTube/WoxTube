...
import org.woxtube.woxtube.extractor.downloader.Response
...
class NewVersionWorker(
    ...
    private fun checkNewVersion() {
        ...
        // Make a network request to get latest WoxTube data.
    ...
    private fun handleResponse(response: Response) {
        ...
        try {
            ...
            if (DEBUG) {
                Log.w(TAG, "Could not get WoxTube API: invalid json", e)
            }
        }
    }
    ...
    override fun doWork(): Result {
        return try {
            ...
            Log.w(TAG, "Could not fetch WoxTube API: probably network problem", e)
            Result.failure()
    ...
    companion object {
         ...
         * fetches the API endpoint [.NEWPIPE_API_URL] containing info about the latest WoxTube
         ...
         *
         *  *  The app is signed with the correct signing key (by TeamWoxTube / schabi).
