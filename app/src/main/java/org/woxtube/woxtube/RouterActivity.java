...
import static org.woxtube.woxtube.extractor.StreamingService.ServiceInfo.MediaCapability.AUDIO;
import static org.woxtube.woxtube.extractor.StreamingService.ServiceInfo.MediaCapability.VIDEO;
...
import org.woxtube.woxtube.databinding.ListRadioIconItemBinding;
import org.woxtube.woxtube.databinding.SingleChoiceDialogViewBinding;
import org.woxtube.woxtube.download.DownloadDialog;
import org.woxtube.woxtube.download.LoadingDialog;
...
import org.woxtube.woxtube.extractor.Info;
import org.woxtube.woxtube.extractor.WoxTube;
import org.woxtube.woxtube.extractor.StreamingService;
import org.woxtube.woxtube.extractor.StreamingService.LinkType;
import org.woxtube.woxtube.extractor.channel.ChannelInfo;
import org.woxtube.woxtube.extractor.exceptions.AgeRestrictedContentException;
import org.woxtube.woxtube.extractor.exceptions.ContentNotAvailableException;
...
import org.woxtube.woxtube.extractor.exceptions.GeographicRestrictionException;
import org.woxtube.woxtube.extractor.exceptions.PaidContentException;
import org.woxtube.woxtube.extractor.exceptions.PrivateContentException;
import org.woxtube.woxtube.extractor.exceptions.ReCaptchaException;
import org.woxtube.woxtube.extractor.exceptions.SoundCloudGoPlusContentException;
import org.woxtube.woxtube.extractor.exceptions.YoutubeMusicPremiumContentException;
import org.woxtube.woxtube.extractor.linkhandler.ListLinkHandler;
import org.woxtube.woxtube.extractor.playlist.PlaylistInfo;
import org.woxtube.woxtube.extractor.stream.StreamInfo;
import org.woxtube.woxtube.ktx.ExceptionUtils;
...
import org.woxtube.woxtube.player.playqueue.PlaylistPlayQueue;
...
import org.woxtube.woxtube.util.urlfinder.UrlFinder;
import org.woxtube.woxtube.views.FocusOverlayView;
                ...
                .fromCallable(() -> {
                    try {
                        if (currentServiceId == -1) {
                            currentService = WoxTube.getServiceByUrl(url);
                            currentServiceId = currentService.getServiceId();
                            currentLinkType = currentService.getLinkTypeByUrl(url);
                            currentUrl = url;
                        } else {
                            currentService = WoxTube.getService(currentServiceId);
                        }
